 ...
 * Lucide v1.x removed all brand icons — these are hand-crafted SVG paths
 * from the official brand guidelines (GitHub, LinkedIn, X/Twitter).
 */
...
const BRAND_ICON_MAP = {
  ...
  x:        XIcon,
} as const satisfies Record<SocialLink['icon'], React.ComponentType<BrandIconProps>>
...
export function BrandIcon({
  icon,
  ...props
}: BrandIconProps & { icon: BrandIconKey }) {
