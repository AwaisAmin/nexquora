...
import { getServicesBySlug, getPublishedServices } from "@/lib/dal";
import { getServiceUrl, BOOKKEEPING_PLANS } from "@/lib/data/services";
...
export default async function FinancePage({
  ...
  const primaryAccent = primary.accentHex ?? "#FFB800";

  // Other services — deduplicate by slug, exclude finance
  const seen = new Set<string>(["finance"]);
  ...
  return (
    <div className="min-h-screen pt-24">
      ...
      <section className="grid-bg relative overflow-hidden py-24">
        <div
          className="pointer-events-none absolute right-0 top-0 h-150 w-150 translate-x-1/3 -translate-y-1/3 rounded-full opacity-8 blur-3xl"
          style={{
            background: `radial-gradient(circle, ${primaryAccent}, transparent)`,
          }}
          aria-hidden
        />
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          >
            <span
              ...
              style={{ background: `${primary.accentHex}18` }}
            >
              <ServiceIcon
                name={primary.icon}
                size={24}
            ...
            {secondary && (
              <>
                ...
                <span
                  className="flex h-14 w-14 items-center justify-center rounded-2xl"
                  style={{ background: `${secondary.accentHex}18` }}
                >
                  <ServiceIcon
                    name={secondary.icon}
                    size={24}
                    strokeWidth={1.6}
                    style={{ color: secondary.accentHex }}
                  />
                </span>
              </>
            )}
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-muted">
            From payment systems and compliance automation to clean books and
            accurate payroll — we handle the financial layer so you can focus on
            the product.
          </p>
        ...
        <div className="grid gap-16 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="glass-card sticky top-24 p-8">
              ...
              {secondary?.caseStudyTeaser && (
                <blockquote
                  className="mt-3 border-l-2 pl-4 text-sm italic text-muted/80"
                  style={{ borderColor: secondary.accentHex }}
                >
                  {secondary.caseStudyTeaser}
                </blockquote>
              )}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-14 text-center">
            ...
            <p className="mt-3 text-sm text-muted">
              All plans include a dedicated bookkeeper, monthly reports, and no
              hidden fees.
            </p>
          </div>
            ...
            {BOOKKEEPING_PLANS.map((plan) => (
              <div
                ...
                className={cn(
                  ...
                  plan.highlighted &&
                    "border-gold/30 shadow-[0_0_40px_rgba(255,184,0,0.08)]",
                )}
              >
                {plan.highlighted && (
                  ...
                  {plan.features.map((f) => (
                    ...
                    >
                      <CheckCircle
                        ...
                        style={{
                          color: plan.highlighted ? "#FFB800" : "#F59E0B",
                        }}
                        aria-hidden
                      />
                      {f}
          ...
          <p className="mt-6 text-center text-xs text-muted">
            Need catch-up bookkeeping? We quote it as a one-time fee added to
            your first month.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <Accordion items={allFaq} accentHex={primaryAccent} />
